...
<form class="row g-3" method="post" action="{{ route('app.processUpload') }}" enctype="multipart/form-data">
    ...
    <div class="col-12">
        ...
        <input type="file" class="form-control" name="driving_license" id="driving_license"" multiple>
        @error('file')
    ...
    <div class="col-12">
        ...
        <input type="file" class="form-control" name="ehs" id="ehs"" multiple>
        @error('ehs')
        <p class=" text-danger text-xs">{{ $message }}</p>
        @enderror
    </div>
    <div class="col-12">
        ...
        <input type="file" class="form-control" name="profile_picture" id="profile_picture"" multiple>
