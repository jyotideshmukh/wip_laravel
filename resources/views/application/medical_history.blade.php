...
<form class="row g-3" method="post" action="{{ route('app.storeMedicalHistory') }}">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-5">
            <div class="form-check">
                <input class="form-check-input" type="radio" name="is_family_history_positive" id="familyHistoryPositiveYes" value="1">
                <label class="form-check-label" for="familyHistoryPositiveYes">Yes</label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="is_family_history_positive" id="familyHistoryPositiveNo" value="0">
